...
function makeBom(screenType: ScreenType, size: number, index: number): BomItem[] {
  ...
  return [
    ...
    {
      id: `TRS-2M-${String(index).padStart(2, "0")}`,
      name: "Truss Segment 2m",
      qty: Math.ceil(size / 6),
      status: statusPick(3),
    },
    {
      id: `CBL-HDM-${String(index).padStart(2, "0")}`,
      name: "HDMI 4K Cable 15m",
      qty: 2,
      status: statusPick(4),
    },
    {
      id: `CBL-PWR-${String(index).padStart(2, "0")}`,
...
export const BOOKINGS: Booking[] = Array.from({ length: 28 }).map((_, index) => {
  ...
  return {
    ...
    contactPerson: pick(
      ["Mr. Bekele", "Ms. Tigist", "Mr. Yonas", "Ms. Mahlet", "Mr. Robel"],
      index,
    ),
...
export const INVENTORY: InventoryItem[] = [
  {
    id: "PNL-P297-01",
    name: "P2.97 LED Panel",
    category: "LED Panels",
    model: "ROE Black Pearl 2V2",
    total: 192,
    available: 128,
    reserved: 48,
    onsite: 12,
  ...
  },
  {
    ...
    lastService: "2026-03-06",
    nextService: "2026-06-06",
  },
  {
    id: "TRS-2M-01",
    name: "2m Box Truss",
...
export const NOTIFICATIONS: Notification[] = [
  {
    id: "n1",
    title: "SB047 moved to Preparation",
    detail: "Bereket accepted the technical assignment and confirmed BOM requirements.",
    time: "4 min",
    type: "Booking",
    priority: "NORMAL",
    unread: true,
    linkTo: "/bookings/SB047",
    date: "Today",
  },
  {
    id: "n2",
    title: "P3.91 cabinet stock is critically low",
    detail: "Only 8 units remain available after reservations. Upcoming bookings may be affected.",
    time: "19 min",
    type: "Inventory",
    priority: "URGENT",
    unread: true,
  ...
  {
    id: "n3",
    title: "Damage report DR-018 requires review",
    detail: "Submitted by Team 2 from Skylight Hall. 3 P4 panels with cracked LED modules.",
    time: "1 hr",
    type: "Damage",
    priority: "URGENT",
    unread: true,
    linkTo: "/damage-report",
    date: "Today",
  },
  {
    id: "n4",
    title: "Payment received for SB041",
    detail: "75,000 ETB marked as paid via bank transfer by the CCR desk.",
    time: "3 hr",
    type: "Payment",
    priority: "NORMAL",
    unread: false,
    linkTo: "/bookings/SB041",
    date: "Today",
  },
  {
    id: "n5",
    title: "Assembly reminder: SB050",
    detail: "Assembly starts tomorrow at 08:00 at Millennium Hall. Truck MED-04 assigned.",
    time: "5 hr",
    type: "Schedule",
    priority: "NORMAL",
    unread: true,
    linkTo: "/bookings/SB050",
    date: "Today",
  },
  {
    id: "n6",
    title: "Overtime driver assigned",
    detail: "Abebe G. assigned as overtime driver for SB048 holiday deployment.",
    time: "6 hr",
    type: "Booking",
    priority: "LOW",
    unread: false,
  ...
  {
    id: "n7",
    title: "BOM submitted for SB044",
    detail:
      "Yeabtsega submitted the Bill of Materials. 48 P2.97 panels, 5 PSUs, 1 NovaStar processor.",
    time: "Yesterday",
    type: "Booking",
    priority: "NORMAL",
    unread: false,
    linkTo: "/bookings/SB044",
    date: "Yesterday",
  },
  {
    id: "n8",
    title: "Material check-in completed",
    detail: "All items from SB039 returned and verified by Selam W. No damage reported.",
    time: "Yesterday",
    type: "Inventory",
    priority: "LOW",
    unread: false,
  ...
  {
    id: "n9",
    title: "Generator service overdue",
    detail: "GEN-45K-01 Perkins P45 was due for service on 2026-06-15. Schedule maintenance.",
    time: "2 days",
    type: "Inventory",
    priority: "URGENT",
    unread: false,
    linkTo: "/inventory/GEN-45K-01",
    date: "This Week",
  },
  {
    id: "n10",
    title: "New staff onboarded",
    detail: "Mahlet Girma added as Technician, Team 3.",
    time: "3 days",
    type: "System",
    priority: "LOW",
    unread: false,
  ...
  {
    id: "n11",
    title: "SB035 marked as DONE",
    detail: "All materials checked in and verified. Job closed successfully.",
    time: "4 days",
    type: "Booking",
    priority: "LOW",
    unread: false,
  ...
  {
    id: "n12",
    title: "Meal budget exceeded",
    detail: "SB042 meal provision exceeded budget by 800 ETB. Review with OO.",
    time: "5 days",
    type: "Payment",
    priority: "NORMAL",
    unread: false,
