...
import { AlertTriangle, ArrowLeft, CalendarClock, CheckCircle2, ClipboardList, MapPin, Package, Pencil, RotateCcw, ShieldAlert, Wrench } from "lucide-react";
...
export function InventoryDetail() {
  ...
  return <AppShell>
    <div className="mb-4 flex items-center justify-between">
      <Link to="/inventory" className="flex items-center gap-2 text-[12px] font-semibold text-text-2">
      ...
      <div className="flex gap-2">
        ...
        <Button variant="outline" size="sm"><RotateCcw /> Stock Movement</Button>
        <Button size="sm" asChild><Link to="/damage-report"><ShieldAlert /> Report Damage</Link></Button>
      </div>
    </div>
